        ...
        <div className="grid grid-cols-2 md:grid-cols-6 gap-8">
          ...
          <div className="col-span-2">
            ...
            <div className="flex gap-3">
              <a href="https://www.linkedin.com/company/uruvika/" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-lg bg-white/5 hover:bg-[#0B94F5]/20 flex items-center justify-center text-gray-400 hover:text-[#0B94F5] transition-all" aria-label="LinkedIn">
