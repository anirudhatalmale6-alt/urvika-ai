      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-2 md:grid-cols-6 gap-8">
          ...
          <div className="col-span-2">
            ...
            <div className="flex gap-3">
              <a href="/#contact" className="w-9 h-9 rounded-lg bg-white/5 hover:bg-[#0B94F5]/20 flex items-center justify-center text-gray-400 hover:text-[#0B94F5] transition-all" aria-label="Twitter">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                </svg>
              </a>
              <a href="/#contact" className="w-9 h-9 rounded-lg bg-white/5 hover:bg-[#0B94F5]/20 flex items-center justify-center text-gray-400 hover:text-[#0B94F5] transition-all" aria-label="LinkedIn">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
          ...
          {Object.entries(footerLinks).map(([title, links]) => (
            <div key={title}>
              ...
              <ul className="space-y-2.5">
                {links.map((link) => (
                  <li key={link}>
                    <a href="/#contact" className="text-sm text-gray-500 hover:text-gray-300 transition-colors duration-200">
                      {link}
                    </a>
                  </li>
                ))}
        ...
        <div className="border-t border-white/10 mt-12 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6">
            <a href="/#contact" className="text-sm text-gray-500 hover:text-gray-400 transition-colors">Privacy Policy</a>
            <a href="/#contact" className="text-sm text-gray-500 hover:text-gray-400 transition-colors">Terms of Service</a>
            <a href="/#contact" className="text-sm text-gray-500 hover:text-gray-400 transition-colors">HIPAA</a>
          </div>
        </div>
      </div>
    </footer>
